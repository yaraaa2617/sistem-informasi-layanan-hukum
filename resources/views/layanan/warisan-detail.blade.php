            ...
            <div class="col-span-2">
                ...
                <div class="bg-white rounded-3xl shadow-lg p-10 mb-8 reveal">
                    ...
                    <p class="text-gray-600 leading-9 text-lg">
                        ...
                        Peralihan hak pembagian bersama adalah proses
                        mengubah status kepemilikan hak bersama menjadi
                        hak individu atas tanah atau bangunan. Proses ini
                        dilakukan dengan membuat Akta Pembagian Hak Bersama (APHB).
